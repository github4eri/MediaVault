...
- `schemas.py` contains Pydantic models (`AssetBase`, `CollectionBase`, etc.) that do not match the actual SQLAlchemy models and are not used by any route — leftover scaffolding.
